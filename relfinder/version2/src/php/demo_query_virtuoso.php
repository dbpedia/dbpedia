	...
	<head>
		...
		<body>
			...
			<form action="">
				...
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=German beer'>German beer</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=German Beer'>German Beer</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=Einstein Alber'>Einstein Alber</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=Albert Einstein Insti'>Albert Einstein Insti</a><br>
				<a href='qdemo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=Albert Einstein Institution'>Albert Einstein Institution</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=Einstein Albert'>Einstein Albert</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=goethe'>goethe</a><br>
				<a href='demo_query_virtuoso.php?endpoint=http://dbpedia.org/sparql?query=&field=Johann Goethe'>Johann Goethe</a><br>
			...
			<?php 
				...
				if(count($swords)==0){
					...
					$tmpstr="SELECT DISTINCT ?s ?o	
					WHERE { ?s  ".RDFS_LABEL." ?o . 	?o 
					bif:contains \"$current\".	
					FILTER (regex(str(?o), '^$current')). \n"
					.   "$globalfilter 	}	
					Limit 10";
			//		$queries['single_word_complete_startswith'] = str_replace(". ",".\n",$tmpstr);
