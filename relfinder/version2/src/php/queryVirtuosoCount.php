...
<!--<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Germa'>Germa</a><br>-->
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Germany'>Germany</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=German Bee'>German Bee</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=German beer'>German beer</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=German Beer'>German Beer</a><br>
<!--<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Einstein Alber'>Einstein Alber</a><br>-->
<!--<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Albert Einstein Insti'>Albert Einstein Insti</a><br>-->
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Albert Einstein Institution'>Albert Einstein Institution</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Einstein Albert'>Einstein Albert</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=goethe'>goethe</a><br>
<a href='queryVirtuosoCount.php?endpoint=http://dbpedia.org/sparql?query=&field=Johann Goethe'>Johann Goethe</a><br>
...
$current = $swords[0];
$queries['single_word_complete_count_outdeg'] = 
"SELECT ?s ?o count(?s) as ?count WHERE { 
?s  ?p ?someobj .
?s  ".RDFS_LABEL." ?o .
...
$queries['single_word_complete_count_indeg'] = 
"SELECT ?s ?o count(?s) as ?count WHERE { 
?someobj  ?p ?s .
?s  ".RDFS_LABEL." ?o .
?o bif:contains \"$current\"
...
$queries['multiple_words_complete_count_indeg'] = 
"SELECT DISTINCT ?s ?o count(?s) as ?count WHERE { 
?someobj  ?p ?s . 
?s  ".RDFS_LABEL." ?o . 
?o bif:contains '$contains2'.
...
function executeSparqlQuery($endpointURI, $defaultgraphURI, $sparqlQueryString){
			...
			echo "<a href='$printurl' target='blank' >link</a>\n";
/*
			echo "<xmp>".$url; die;
*/
			$c = curl_init();
