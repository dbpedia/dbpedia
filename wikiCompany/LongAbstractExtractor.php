...
/**
 * Exracts the first section from a Wikipedia article
 * 
 */

class LongAbstractExtractor implements Extractor 
{
	const extractorID = "http://dbpedia.org/extractors/LongAbstractsExtractor";
    private $language;
    ...
    public function extractPage($pageID, $pageTitle,  $pageSource) {
        ...
        $result->addTriple(
                ...
                RDFtriple::predicate("abstract"),
                RDFtriple::Literal($LongAbstract, NULL, $this->language));
