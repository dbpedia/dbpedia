<?php
/**
 * The AllCategoriesSqlIterator cycles over all Categories
 * in the DBpedia MySQL database. Database settings have to be
 * specified in extraction/config.inc.php.
 * 
 */
class AllCategoriesSqlIterator implements Iterator
{
    protected $row = null;
	...
	if($language == "en")
{	
		$query = "select page_title, page_namespace from wc_page where (page_namespace = 14 ) and page_is_redirect = 0";
	}
